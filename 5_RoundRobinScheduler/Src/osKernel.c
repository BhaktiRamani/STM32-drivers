...
/*When exception occurse these registers are automatically saved
 * onto the stack : r0, r1, r2, r3, r12, lr, pc
 *
 */
__attribute__((naked)) void System_Handler(void)
{
	...
	/*CHOOSE NEXT THREAD*/
	/*Load r1 from a location 4bytes above address r1 i.e. r1 = currentPt -> nextPt**/
	__asm("LDR R1, [R1, #4]");
